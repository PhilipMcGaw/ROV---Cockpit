...
echo [INFO] Important paths: package=%PROJECT_ROOT%\src\rov_cockpit, configuration=%PROJECT_ROOT%\configs
...
if not exist "%PROJECT_ROOT%\src\rov_cockpit\app.py" (
 echo [FAIL] Cockpit entry point not found: %PROJECT_ROOT%\src\rov_cockpit\app.py
