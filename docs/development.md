...
The attitude arc is rendered as matching left and right segments. No amber or yellow aircraft reference marks are drawn inside the arcs. All pitch markers are solid, and their inner ends touch the arcs; the centre line is slightly thicker.
